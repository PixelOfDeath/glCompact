...
namespace glCompact {
    namespace config {
        ...
        namespace version {
            constexpr GlVersion   glMin   = GlVersion::notSupported; //glCompact requires this to be at last v33
            constexpr GlesVersion glesMin = GlesVersion::v30;        //glCompact requires this to be at last v32 ?
        }
