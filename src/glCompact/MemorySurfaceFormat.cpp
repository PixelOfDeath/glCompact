...
namespace glCompact {
    ...
    const MemorySurfaceFormatDetail memorySurfaceFormatDetailUncompressed[] = {
      ...
      // |                              |                                               |                   |                                   |    |   |    |  |  |  |  |  |
        ...
        {"R3G3B2_UNORM_PACK8",          0,                                              GL_RGB            , GL_UNSIGNED_BYTE_3_3_2           ,  1,   1,  1,   1, 0, 0, 0, 0, 0},
        {"R3G3B2_UINT_PACK8",           0,                                              GL_RGB_INTEGER    , GL_UNSIGNED_BYTE_3_3_2           ,  1,   1,  1,   0, 1, 0, 0, 0, 0},
        {"B2G3R3_UNORM_PACK8",          0,                                              GL_RGB            , GL_UNSIGNED_BYTE_2_3_3_REV       ,  1,   1,  1,   1, 0, 0, 0, 0, 0},
        {"B2G3R3_UINT_PACK8",           0,                                              GL_RGB_INTEGER    , GL_UNSIGNED_BYTE_2_3_3_REV       ,  1,   1,  1,   0, 1, 0, 0, 0, 0},
    ...
    //GL_UNSIGNED_INT_8_8_8_8 is already covered by {GL_RGBA, GL_UNSIGNED_BYTE}
      ...
      //{"B8G8R8A8_UNORM",              0,                                              GL_BGRA           , GL_UNSIGNED_INT_8_8_8_8          ,  4,   1,  1,   1, 0, 0, 0, 0, 0},
        ...
        {"B10G11R11_UFLOAT_PACK32",     0,                                              GL_RGB            , GL_UNSIGNED_INT_10F_11F_11F_REV  ,  4,   1,  1,   1, 0, 0, 0, 0, 0},
      //{"R11G11B10_UFLOAT_PACK32",     0,                                              GL_BGR            , GL_UNSIGNED_INT_10F_11F_11F_REV  ,  4,   1,  1,   1, 0, 0, 0, 0, 0}, ?
        {"E5B9G9R9_UFLOAT_PACK32",      0,                                              GL_RGB            , GL_UNSIGNED_INT_5_9_9_9_REV      ,  4,   1,  1,   1, 0, 0, 0, 0, 0},
      //{"E5R9G9B9_UFLOAT_PACK32",      0,                                              GL_BGR            , GL_UNSIGNED_INT_5_9_9_9_REV      ,  4,   1,  1,   1, 0, 0, 0, 0, 0}, ?
      ...
      //{"S16_UINT",                    0,                                              GL_STENCIL_INDEX,   GL_UNSIGNED_SHORT,                  2,   1,  1,   0, 0, 0, 1, 0, 0},
